...
<div id="demo">
  <ul>
  <li><a href="/vlib/stats.php"><h1>Most Played Games</h1></a></li>
  <li class="active"><a href="/vlib/stats1.php"><h1>Most Owned Games</h1></a></li>
</ul>
  <h2></h2>
...
<?php
    ...
    if($result=mysqli_query($conn,"CALL counter")){
        while($row=mysqli_fetch_row($result)){
            echo "<tr>";
            echo "<td data-title=\"Game\">";  printf ("%s",$row[0]); echo "</td>";
            echo "<td data-title=\"No. of Owners\">";  printf ("%d",$row[1]); echo "</td>";
            echo "</tr>";
